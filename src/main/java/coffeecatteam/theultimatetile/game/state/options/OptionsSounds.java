...
public class OptionsSounds extends StateAbstractOptions {
    ...
    public OptionsSounds(GameEngine gameEngineIn) {
        ...
        uiManager.addObject(new UIButtonSlider(gameEngineIn, 15, 15, "Music") {
            @Override
        ...
        uiManager.addObject(new UIButtonSlider(gameEngineIn, 15, 94, "Passive") {
            @Override
            public float changeValue(float amt) {
        ...
        uiManager.addObject(new UIButtonSlider(gameEngineIn, 15, 173, "Hostile") {
            @Override
            public float changeValue(float amt) {
        ...
        uiManager.addObject(new UIButtonSlider(gameEngineIn, 15, 252, "Player") {
            @Override
            public float changeValue(float amt) {
        ...
        uiManager.addObject(new UIButtonSlider(gameEngineIn, 15, 331, "Other") {
            @Override
            public float changeValue(float amt) {
