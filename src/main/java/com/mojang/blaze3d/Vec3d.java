...
import team.abnormals.tut_new.Direction;
...
public class Vec3d implements Position {
   ...
   public Vec3d(Vec3i vec3i_1) {
      this((double)vec3i_1.getX(), (double)vec3i_1.getY(), (double)vec3i_1.getZ());
   }
   ...
   @Environment(EnvType.CLIENT)
   public static Vec3d fromPolar(Vec2f vec2f_1) {
      return fromPolar(vec2f_1.x, vec2f_1.y);
   }
   ...
   public Vec3d floorAlongAxes(EnumSet<Direction.Axis> enumSet_1) {
      double double_1 = enumSet_1.contains(Direction.Axis.X) ? (double)MathHelper.floor(this.x) : this.x;
      double double_2 = enumSet_1.contains(Direction.Axis.Y) ? (double)MathHelper.floor(this.y) : this.y;
      double double_3 = enumSet_1.contains(Direction.Axis.Z) ? (double)MathHelper.floor(this.z) : this.z;
      return new Vec3d(double_1, double_2, double_3);
   }

   public double getComponentAlongAxis(Direction.Axis direction$Axis_1) {
      return direction$Axis_1.choose(this.x, this.y, this.z);
   }
