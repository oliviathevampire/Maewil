...
public class GlDebug {
   ...
   private static String unknown(int int_1) {
      return "Unknown (0x" + Integer.toHexString(int_1).toUpperCase() + ")";
   }

   private static String getSource(int int_1) {
      switch(int_1) {
      case 33350:
         return "API";
      case 33351:
   ...
   private static String getType(int int_1) {
      switch(int_1) {
      case 33356:
         return "ERROR";
      case 33357:
   ...
   private static String getSeverity(int int_1) {
      switch(int_1) {
      case 33387:
         return "NOTIFICATION";
      case 37190:
   ...
   private static void info(int int_1, int int_2, int int_3, int int_4, int int_5, long long_1, long long_2) {
      LOGGER.info("OpenGL debug message, id={}, source={}, type={}, severity={}, message={}", int_3, getSource(int_1), getType(int_2), getSeverity(int_4), GLDebugMessageCallback.getMessage(int_5, long_1));
   }

   private static void registerConstant(int int_1, String string_1) {
      CONSTANTS.merge(int_1, string_1, (string_1x, string_2) -> {
         return string_1x + "/" + string_2;
      });
   }

   public static void enableDebug(int int_1, boolean boolean_1) {
      if (int_1 > 0) {
         GLCapabilities gLCapabilities_1 = GL.getCapabilities();
         int int_3;
         boolean boolean_3;
         if (gLCapabilities_1.GL_KHR_debug) {
            GL11.glEnable(37600);
            if (boolean_1) {
               GL11.glEnable(33346);
            }

            for(int_3 = 0; int_3 < KHR_VERBOSITY_LEVELS.size(); ++int_3) {
               boolean_3 = int_3 < int_1;
               KHRDebug.glDebugMessageControl(4352, 4352, (Integer)KHR_VERBOSITY_LEVELS.get(int_3), (int[])null, boolean_3);
            }
         ...
         } else if (gLCapabilities_1.GL_ARB_debug_output) {
            if (boolean_1) {
               GL11.glEnable(33346);
            }

            for(int_3 = 0; int_3 < ARB_VERBOSITY_LEVELS.size(); ++int_3) {
               boolean_3 = int_3 < int_1;
               ARBDebugOutput.glDebugMessageControlARB(4352, 4352, (Integer)ARB_VERBOSITY_LEVELS.get(int_3), (int[])null, boolean_3);
            }
